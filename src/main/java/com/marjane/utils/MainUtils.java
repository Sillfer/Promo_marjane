...
public class MainUtils {
    ...
    public static void superAdminWorkFlow() {
        ...
        GeneralAdminDao superAdminDao = new GeneralAdminDao();
        // check if email and password are correct
        if (superAdminDao.validateGeneralAdminLogin(superAdminLogin)) {
            ...
            do {
                ...
                switch (choice) {
                    case 1:
                        ...
                        if (managerDao.createRespRayon(newRespRayon)) {
    ...
    public static void respRayonWorkflow() {
        ...
        PromotionDao promotionDao = new PromotionDao();
        ManagerDao managerDao = new ManagerDao();
        if (managerDao.validateRespRayonLogin(managerLogin)) {
            do {
